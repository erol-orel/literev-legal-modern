...
import { fetchHighlightedDocumentContent } from "../../libs/document_content";
...
function HighlightedDocument({ context }) {
  ...
  useEffect(() => {
    ...
    fetchHighlightedDocumentContent(context.api, documentRagId)
      .then((data) => {
        setPayload(data);
        setErrors([]);
      })
  ...
  return (
    <section className="py-5 mt-5">
      ...
      <HighlightedContent content={payload.content} />
